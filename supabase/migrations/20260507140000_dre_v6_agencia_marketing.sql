-- =====================================================
-- DRE v6 — Agência de Marketing volta pra sales_cost
-- =====================================================
-- Diagnóstico em Fev/26 mostrou:
--   * Marketplace (Comissão Ifood + Antecipação + Brendi): R$ 48.219,57 ≈ Saipos R$ 48.220,11 ✓
--   * Taxas Cartão (Cred/Deb/Pix + Vouchers): R$ 9.848,90 ≈ Saipos R$ 10.096,90 ✓
--   * Marketing (sem Agência): R$ 19.843 vs Saipos R$ 22.144 → gap R$ 2.301 = Agência de Marketing
--
-- Apesar do screenshot da config Saipos mostrar Agência como "Selecione a
-- seção", o DRE Gerencial inclui ela em Marketing. Movendo pra sales_cost.
-- =====================================================
...
AS $$
  SELECT CASE
    ...
    -- CMV (vazio — Saipos calcula via baixa de estoque)
    ...
    -- Marketing (Agência incluída — diagnóstico fev/26 mostrou que Saipos inclui)
